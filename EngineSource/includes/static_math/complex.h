...
namespace smath
{
    ...
    template<typename T>
    auto operator<<(std::ostream& os, const imaginary<T>& im)
        -> std::ostream&;
    ...
    struct complex
    {
        ...
        constexpr complex(value_type real, imaginary<value_type> imag):
            real(real),
            imag(imag)
        {}
        ...
        constexpr operator imaginary<value_type>() const
        {
            return imag;
        }
        ...
        const imaginary<value_type> imag;
    };

    template<typename T>
    auto operator<<(std::ostream& os, const complex<T>& z)
        -> std::ostream&;
