...
typedef enum
{
    ...
    FMOD_DSP_PAN_SURROUND_STEREO_SEPARATION,    /* (Type:float) - Stereo-To-Surround Stereo  For FMOD_DSP_PAN_SURROUND_FROM_STEREO_MODE_DISCRETE mode.  Separation/right of L/R parts of stereo sound. -180.0 (degrees) to +180.0 (degrees).  Default = 60.0. */
