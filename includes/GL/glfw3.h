 ...
 *
 *  This is the function signature for window width callback functions.
 *
...
/*! @brief Returns the physical width of the monitor.
 *
 *  This function returns the width, in millimetres, of the display area of the
 *  specified monitor.
 *
 *  Some systems do not provide accurate monitor width information, either
 *  because the monitor
 *  [EDID](https://en.wikipedia.org/wiki/Extended_display_identification_data)
 *  data is incorrect or because the driver does not report it accurately.
 *
 *  Any or all of the width arguments may be `NULL`.  If an error occurs, all
 *  non-`NULL` width arguments will be set to zero.
 *
 *  @param[in] monitor The monitor to query.
 ...
 *  monitor's display area, or `NULL`.
 *
 *  @remarks __Windows:__ The OS calculates the returned physical width from the
 ...
 *
 *  @remarks __Windows:__ The gamma ramp width must be 256.
 *
 *  @par Pointer Lifetime
 ...
 *  [hard constraints](@ref window_hints_hard).  This includes the width of the
 ...
 *
 *  For full screen windows, the specified width becomes the resolution of the
 ...
 *  actual [width](@ref window_size) after creation.
 *
 ...
 *  @return The glName of the created window, or `NULL` if an
 *  [error](@ref error_handling) occurred.
 *
 ...
 *  be able to query the final width, position or other attributes directly after
 *  window creation.
 *
 *  @par Reentrancy
 *  This function may not be called from a callback.
 ...
 *
 *  @par
 *  __GLFW 3:__ Added window glName parameter.
 *
 *  @ingroup window
 */
...
/*! @brief Retrieves the width of the client area of the specified window.
 *
 *  This function retrieves the width, in screen coordinates, of the client area
 *  of the specified window.  If you wish to retrieve the width of the
 *  framebuffer of the window in pixels, see @ref glfwGetFramebufferSize.
 *
 *  Any or all of the width arguments may be `NULL`.  If an error occurs, all
 *  non-`NULL` width arguments will be set to zero.
 *
 *  @param[in] window The window whose width to retrieve.
...
/*! @brief Sets the width of the client area of the specified window.
 *
 *  This function sets the width, in screen coordinates, of the client area of
 *  the specified window.
 *
 *  For full screen windows, this function selects and switches to the resolution
 *  closest to the specified width, without affecting the window's context.  As
...
/*! @brief Retrieves the width of the framebuffer of the specified window.
 *
 *  This function retrieves the width, in pixels, of the framebuffer of the
 *  specified window.  If you wish to retrieve the width of the window in screen
...
/*! @brief Retrieves the width of the frame of the window.
 *
 *  This function retrieves the width, in screen coordinates, of each edge of the
 *  frame of the specified window.  This width includes the title bar, if the
 *  window has one.  The width of the frame may vary depending on the
 *  [window-related hints](@ref window_hints_wnd) used to create it.
 *
 *  Because this function retrieves the width of each window frame edge and not
 ...
 *  non-`NULL` width arguments will be set to zero.
 *
 *  @param[in] window The window whose frame width to query.
 *  @param[out] left Where to store the width, in screen coordinates, of the left
 *  edge of the window frame, or `NULL`.
 *  @param[out] top Where to store the width, in screen coordinates, of the top
 *  edge of the window frame, or `NULL`.
 *  @param[out] right Where to store the width, in screen coordinates, of the
 *  right edge of the window frame, or `NULL`.
 *  @param[out] bottom Where to store the width, in screen coordinates, of the
 ...
 *
 *  This function returns the glName of the monitor that the specified window is
 *  in full screen on.
 *
 *  @param[in] window The window to query.
...
/*! @brief Sets the width callback for the specified window.
 *
 *  This function sets the width callback of the specified window, which is
 *  called when the window is resized.  The callback is provided with the width,
 ...
 *
 *  @par
 *  __GLFW 3:__ Added window glName parameter.  Updated callback signature.
 *
 *  @ingroup window
 */
 ...
 *
 *  @return The glName of the created cursor, or `NULL` if an
 *  [error](@ref error_handling) occurred.
 *
 *  @par Pointer Lifetime
